...
class UploadHandler
{
            ...
            'image_versions' => array(
                ...
                */
                'thumbnail' => array(
                    ...
                    'upload_dir' => '/var/www/thumb_test/',
                    'upload_url' => '/thumb_test/',
    ...
    protected function handle_form_data($file, $index) {
        ...
        $typed   = addslashes($_POST['type_grid']);
        $message = addslashes($_POST['message']);
        $geo     = addslashes($_POST['geo']);
        ...
        file_put_contents("/tmp/do_post.log", "user-$user\nuid-$uid\n", FILE_APPEND);
        ...
        if($topic == "#") {
          // This is blank, bail
          file_put_contents("/tmp/do_post.log", "Topic came through empty - $topic", FILE_APPEND);
